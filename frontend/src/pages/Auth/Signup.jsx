        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md ">
            <div className={`${isDark ? "bg-gray-800" : "bg-white"} px-4 pb-4 z-20 pt-8 border-2 border-black rounded shadow-sm sm:rounded-lg sm:px-10 sm:pb-6 sm:shadow`}>
                ...
                <form className="space-y-6 mt-4">
                    ...
                    <div>
                        <label htmlFor="password" className={`block text-sm font-para font-regular ${isDark ? "text-white/70" : "text-black/80"}`}>Confirm Password</label>
                        <div className="mt-1">
                            <input id="password" name="password" type="password" data-testid="password"
                                autoComplete="current-password" required=""
                                className="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm  sm:text-sm"
                ...
                <div className="m-auto mt-6 w-fit md:mt-8">
                    <span className={`text-[14px] m-auto font-para font-regular ${isDark ? "text-white/50" : "text-black/50"}`}>Already have an account?
                        <a className="font-regular font-para text-orange-400 hover:text-orange-200" href="/register">Sigin</a>
                    </span>
                </div>
            </div>
        </div>
